...
Message({
    ...
    'endianness': '!',
    'members': [
        {'key': "Temp",       'stype': "h", 'units': {'mks': "celsius"}},
        {'key': "Hum",        'stype': "h", 'units': {'mks': "percent"}},
        {'key': "Soil",       'stype': "h", 'units': {'mks': "unknown"}},
        {'key': "Light",      'stype': "h", 'units': {'mks': "unknown"}},
        {'key': "CO2",        'stype': "h", 'units': {'mks': "ppm"}},
        {'key': "R1_Power",   'stype': "h", 'units': {'mks': "watts"}},
        {'key': "R1_Current", 'stype': "h", 'units': {'mks': "amps"}},
    ]
}),
Message({
    'name': "State",
